...
func main() {
	...
	fmt.Println()
	fmt.Println("3. LOOPS MODULE - Loops and control flow")
	fmt.Println("   Topics: For loops, While-style loops, Infinite loops,")
	fmt.Println("           Break and Continue, Range keyword, Nested loops,")
	fmt.Println("           Labeled statements, Loop patterns, Performance")
	fmt.Println("   Run: go run cmd/03-loops/main.go")
	fmt.Println()
	fmt.Println("4. COLLECTIONS MODULE - Arrays, Slices, and Maps")
	fmt.Println("   Topics: Fixed-size arrays, Dynamic slices, Hash maps,")
	fmt.Println("           Append and copy operations, Slice patterns,")
	fmt.Println("           Map operations, Common collection patterns")
	fmt.Println("   Run: go run cmd/04-collections/main.go")
	fmt.Println()
	...
	fmt.Println("├── loops/                  # Loops and control flow package")
	fmt.Println("│   └── loops.go           # All loop concepts")
	fmt.Println("├── collections/            # Collections package")
	fmt.Println("│   └── collections.go     # Arrays, slices, and maps")
	...
	fmt.Println("    ├── 03-loops/")
	fmt.Println("    │   └── main.go        # Demo runner for loops")
	fmt.Println("    └── 04-collections/")
	fmt.Println("        └── main.go        # Demo runner for collections")
	fmt.Println()
